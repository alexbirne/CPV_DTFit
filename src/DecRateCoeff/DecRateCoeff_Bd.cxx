...
DecRateCoeff_Bd::DecRateCoeff_Bd(const std::string& name,
  ...
  eta_os_("eta_os_","eta_os_",this,_omegab_os_),
  omegab_os_("omegab_os_","omegab_os_",this,_omegab_os_),
  omegabbar_os_("omegabbar_os_","omegabbar_os_",this,_omegabbar_os_),
  avg_eta_os_("avg_eta_os_","avg_eta_os_",this,_omegab_os_),
  p0_os_("p0_os_","p0_os_",this,_omegab_os_),
  p1_os_("p1_os_","p1_os_",this,_omegab_os_),
  delta_p0_os_("delta_p0_os_","delta_p0_os_",this,_omegab_os_),
  delta_p1_os_("delta_p1_os_","delta_p1_os_",this,_omegab_os_),
  ...
  eta_ss_("eta_ss_","eta_ss_",this,_omegab_ss_),
  omegab_ss_("omegab_ss_","omegab_ss_",this,_omegab_ss_),
  omegabbar_ss_("omegabbar_ss_","omegabbar_ss_",this,_omegabbar_ss_),
  avg_eta_ss_("avg_eta_ss_","avg_eta_ss_",this,_omegab_ss_),
  p0_ss_("p0_ss_","p0_ss_",this,_omegab_ss_),
  p1_ss_("p1_ss_","p1_ss_",this,_omegab_ss_),
  delta_p0_ss_("delta_p0_ss_","delta_p0_ss_",this,_omegab_ss_),
  delta_p1_ss_("delta_p1_ss_","delta_p1_ss_",this,_omegab_ss_),
...
DecRateCoeff_Bd::DecRateCoeff_Bd(const std::string& name,
  ...
  eta_ss_("eta_ss_","eta_ss_",this,_omegab_os_),
  omegab_ss_("omegab_ss_","omegab_ss_",this,_omegab_os_),
  omegabbar_ss_("omegabbar_ss_","omegabbar_ss_",this,_omegabbar_os_),
  avg_eta_ss_("avg_eta_ss_","avg_eta_ss_",this,_omegab_os_),
  p0_ss_("p0_ss_","p0_ss_",this,_omegab_os_),
  p1_ss_("p1_ss_","p1_ss_",this,_omegab_os_),
  delta_p0_ss_("delta_p0_ss_","delta_p0_ss_",this,_omegab_os_),
  delta_p1_ss_("delta_p1_ss_","delta_p1_ss_",this,_omegab_os_),
...
DecRateCoeff_Bd::DecRateCoeff_Bd(const std::string& name,
  ...
  omegab_ss_("omegab_ss_","omegab_ss_",this,_eta_os_),
  omegabbar_ss_("omegabbar_ss_","omegabbar_ss_",this,_eta_os_),
...
DecRateCoeff_Bd::DecRateCoeff_Bd(const std::string& name,
  ...
  finalstate_("finalstate_","finalstate_",this,_finalstate_),
  tag_os_("tag_os_","tag_os_",this,_tag_os_),
  eta_os_("eta_os_","eta_os_",this,_eta_ss_),
  omegab_os_("omegab_os_","omegab_os_",this,_omegab_os_),
  omegabbar_os_("omegabbar_os_","omegabbar_os_",this,_omegabbar_os_),
  avg_eta_os_("avg_eta_os_","avg_eta_os_",this,_avg_eta_ss_),
  p0_os_("p0_os_","p0_os_",this,_p0_ss_),
  p1_os_("p1_os_","p1_os_",this,_p1_ss_),
  delta_p0_os_("delta_p0_os_","delta_p0_os_",this,_delta_p0_ss_),
  delta_p1_os_("delta_p1_os_","delta_p1_os_",this,_delta_p1_ss_),
  tageff_os_("tageff_os_","tageff_os_",this,_tageff_os_),
  tageff_asym_os_("tageff_asym_os_","tageff_asym_os_",this,_tageff_asym_os_),
  tag_ss_("tag_ss_","tag_ss_",this,_tag_ss_),
  eta_ss_("eta_ss_","eta_ss_",this,_eta_ss_),
...
DecRateCoeff_Bd::DecRateCoeff_Bd(const std::string& name,
  ...
  tag_os_("tag_os_","tag_os_",this,_tag_os_),
  eta_os_("eta_os_","eta_os_",this,_eta_os_),
  omegab_os_("omegab_os_","omegab_os_",this,_omegab_ss_),
  omegabbar_os_("omegabbar_os_","omegabbar_os_",this,_omegabbar_ss_),
  avg_eta_os_("avg_eta_os_","avg_eta_os_",this,_avg_eta_os_),
  p0_os_("p0_os_","p0_os_",this,_p0_os_),
  p1_os_("p1_os_","p1_os_",this,_p1_os_),
  delta_p0_os_("delta_p0_os_","delta_p0_os_",this,_delta_p0_os_),
...
DecRateCoeff_Bd::DecRateCoeff_Bd(const DecRateCoeff_Bd& other, const char* name) :
  ...
  glmmodel_os_(other.glmmodel_os_),
  glmmodel_ss_(other.glmmodel_ss_)
{
}
                                   ...
                                   double detection_asym) const
{
  ...
  else if(!onetagger_ && !glmmodel_os_ && !glmmodel_ss_)
  {
  ...
  else if(onetagger_ && glmmodel_os_){
    std::pair<double, double> calibrated_mistag_os = calibrate(omegab_os, omegabbar_os);
  ...
  else if(!onetagger_ && glmmodel_ss_){
    std::pair<double, double> calibrated_mistag_os = calibrate(eta_os, avg_eta_os, p0_os, p1_os, delta_p0_os, delta_p1_os);
    std::pair<double, double> calibrated_mistag_ss = calibrate(omegab_ss, omegabbar_ss);
    ...
    std::cout << "ERROR\t" << "DecRateCoeff_Bd::evaluate(...): No valid tagger calibration strategy!" << std::endl;
    abort();
  }
  ...
  if(onetagger_) {
    ...
    if(coeff_type == kSinh){
      if(finalstate == 1){
        ...
        else return 1.0 * cp_coeff * (1 + detection_asym) * (tageff_os - 0.5 * tag_os * tageff_asym_os
        ...
        else return 1.0 * cp_coeff_bar * (1 - detection_asym) * (tageff_os - 0.5 * tag_os * tageff_asym_os
                                                                     - tag_os * production_asym * (tageff_os - 0.5 * tag_os * tageff_asym_os
                                                                                                  - tageff_os * (eta_os_b + eta_os_bbar)
                                                                                                  + 0.5 * tageff_asym_os * (eta_os_b - eta_os_bbar))
                                                                     - tageff_os * tag_os * (eta_os_b - eta_os_bbar)
