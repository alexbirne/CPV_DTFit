...
public:
  ...
  // constructor for GLM calibration using two taggers
  ...
  // constructor for GLM calibration using one tagger
  DecRateCoeff_Bd(const std::string& name,
                  const std::string& title,
                  CoeffType   _coeff_type_,
                  RooAbsCategory& _finalstate_,
  ...
  // constructor for linear calibration using two taggers
  DecRateCoeff_Bd(const std::string& name,
                  const std::string& title,
                  CoeffType   _coeff_type_,
                  RooAbsCategory& _finalstate_,
  ...
  // constructor for linear calibration using one tagger
  DecRateCoeff_Bd(const std::string& name,
                  const std::string& title,
                  CoeffType   _coeff_type_,
                  RooAbsCategory& _finalstate_,
  ...
  // constructor for two taggers using glm calibration for the OS and linear calibration for the SS
  DecRateCoeff_Bd(const std::string& name,
                  const std::string& title,
                  CoeffType   _coeff_type_,
                  RooAbsCategory& _finalstate_,
  ...
  // constructor for two taggers using  linear calibration for the SS and glm calibration for the OS
  DecRateCoeff_Bd(const std::string& name,
                  const std::string& title,
                  CoeffType   _coeff_type_,
                  RooAbsCategory& _finalstate_,
